...
- Fixed the `project_weak_copyleft_license_count`, `project_other_license_count` and `project_license_table `queries to use the latest version of EUP (European Union Public License). ([#13](https://github.com/turbot/steampipe-mod-gitlab-insights/pull/13))
